...
'''Output'''
"""Inception has been borrowed by Sairaj
The Matrix is not available in the library
Sairaj has borrowed: ['Inception']
Inception has been returned to the library by Sairaj
Titanic was not borrowed by Sairaj
Sairaj has borrowed: []"""