...
member1 = LibraryMember("Hritik")
member2 = LibraryMember("Pratik")
...
Sairaj has borrowed Python Programming
Book not available.
Total Books: 3
Available Books: Data Structures, Machine Learning, AI Basics
Sairaj has returned Python Programming
Shubham has not borrowed Data Structures
Total Books: 4
